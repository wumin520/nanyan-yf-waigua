  ...
  优化企业福利待遇</div>
      ...
      <div id="section2" class="section_ section_1_">
        ...
        <div style="height: 300px;">
            ...
            <circle cx="246" cy="60" r="10" stroke="#297FFF"
            stroke-width="2" fill="#297FFF"/>
            <circle cx="497" cy="252" r="10" stroke="#297FFF"
            stroke-width="2" fill="#297FFF"/>
            <circle cx="757" cy="60" r="10" stroke="#297FFF"
            stroke-width="2" fill="#297FFF"/>
            
            <text font-weight="600" font-size="18" fill="#297FFF" text-anchor="middle" 
                      y="155" x="238">微信申请理赔</text>
            <text font-size="12" fill="black" text-anchor="middle" 
                      y="180" x="238">关注公众号，在线申请</text>
            <text font-size="46" fill="rgba(51,51,51,0.3)" text-anchor="middle" 
                      y="36" x="248">01</text>
            <text font-weight="600" font-size="18" fill="#297FFF" text-anchor="middle" 
                      y="105" x="490">拍照上传单据</text>
            <text font-size="12" fill="black" text-anchor="middle" 
                      y="150" x="492">
                            医疗理赔2000元以下<br/>免收原始纸质单据</text>
            <text font-size="46" fill="rgba(51,51,51,0.3)" text-anchor="middle" 
                      y="300" x="495">02</text>
            <text font-weight="600" font-size="18" fill="#297FFF" text-anchor="middle" 
                      y="155" x="760">赔款给付</text>
            <text font-size="12" fill="black" text-anchor="middle" 
                      y="180" x="760">
                            审核通过，打款报销<br/>全程透明，进度清晰可查</text>
            <text font-size="46" fill="rgba(51,51,51,0.3)" text-anchor="middle" 
                      y="36" x="760">03</text>
            <image xlink:href="/img/img4.1841da17.png" x="200" y="220" height="79" width="79" />
            </svg>
        </div>
      </div>
      <div id="section3" class="section_ section_3_">
        ...
        <div>
          ...
          <div class="right_">
            ...
            <div class="desc_">
                            宇泰员福是专业的企业员工保险平台，基于成熟的产品和系统服务经验，我们为企业提供一站式员工保险服务和员工保险管理系统，目前宇泰员福已与人保财险、光大永明、中航安盟等知名保险公司签约合作。
我们的团队是一支年轻且富有想象力的创业团队，专业、专注、敢于实践。团队核心成员来自于太阳联合，美亚，平安，友邦等著名保险公司以及甲骨文、软通动力中科软等著名IT公司，核心成员均有超过十年的保险行业和大数据运营经验。
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="footer_">
        ...
        <a-row class="pre_">
          <a-col :span="12">
            <div class="left_">
              ...
              <div class="mrg_b23"><a-icon type="phone" />南燕客服专线：400-820-3433（服务时间9:30-17:30）</div>
      ...
      <div class="company_info_">
        上海南燕信息技术有限公司 © 2014-2018 Insgeek.com All Rights Reserved 京ICP备 
      </div>
    </div>
  </div>
</template>
        ...
        li {
          ...
          &.active {
            &::after {
              ...
              width:36px;
              height:1px;
              background:linear-gradient(90deg,rgba(0,240,255,1) 0%,rgba(0,132,255,1) 100%);
              border-radius:1px;
              margin-top: 28px;
            }
          }
    ...
    .section_3_ {
      ...
      .right_ {
        ...
        .item_title_ {
          ...
          padding-bottom: 20px;
          width: 133px;
          border-bottom: 1px solid rgba(41,127,255,1);
          margin-bottom: 21px;
        }
        .desc_ {
          font-size:13px;
